        ...
        <div class="container">
          <div class="row">
            ...
            <form action="{{ route('detail-add', $product->id) }}" method="post" enctype="multipart/form-data">
              @csrf  
              <button
              class=" btn btn-success nav-link px-4 text-white btn-block mb-3" type="submit">
              Add to Cart
              </button> </form>
            @else
            <a href="{{ url('login') }}" class=" btn btn-success nav-link px-4 text-white btn-block mb-3">Login</a>
              @endauth
            </div>
          </div>
        </div>
